...
const PROXY_BASE = '';
const APP_ID = '6a43dc0ccfb23aec5c0f285d';
...
export default function PublicFormKundenstamm() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Kundenstamm — Formular</h1>
        </div>
